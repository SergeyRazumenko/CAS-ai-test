...
const StepConfirmation = ({
  ...
  return (
    <section className="registration-form__section" aria-labelledby="step-confirmation-title">
      ...
      <div className="form-check mb-3 registration-form__field">
        ...
        {errors.agreeToTerms && (
          <div id="agreeToTerms-error" className="invalid-feedback d-block">{errors.agreeToTerms}</div>
        )}
      </div>
