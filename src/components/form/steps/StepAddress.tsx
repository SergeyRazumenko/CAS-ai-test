...
const StepAddress = ({
  ...
  return (
    <section className="registration-form__section" aria-labelledby="step-address-title">
      ...
      <div className="mb-3 registration-form__field">
        ...
        {errors.country && (
          <div id="country-error" className="invalid-feedback d-block">{errors.country}</div>
        )}
      </div>
      ...
      <div className="mb-3 registration-form__field">
        ...
        />
        {errors.city && (
          <div id="city-error" className="invalid-feedback d-block">{errors.city}</div>
        )}
      </div>
